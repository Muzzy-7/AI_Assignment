...
This project implements a simple reflex agent which determined the AQI( Air Quality Index) for a different location using the sensor data from the environment. 
